                ...
                <div class="row justify-content-center">
                    <div class="col-2">
                        <div class="account-picture d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="">
                                <button class="btn fw-bold injaaz-btn" onclick="showChangePhotoModal()">تغيير
                                    الصورة</button>
                            </div>
                            {{-- change-photo-modal --}}
                            <div id="change-photo-modal" class="modal change-photo-modal" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-center" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header px-4">
                                            <button type="button" class="close injaaz-btn-close close-change-photo-modal"
                                                data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <h5>الصورة الظاهر تعتمد على حساب الإيميل المسجل على موقع gravatar اذا أردت تغيير
                                                الصورة قم بتغييرها من الموقع <a target="_blank"
                                                    href="https://www.gravatar.com">gravatar</a></h5>
                                        </div>
                    ...
                    <div class="col-8">
                        {{-- Start Form --}}
                        <form method="POST" action="{{ route('account.settings.update', ['userId' => $user->id]) }}"
                            class="row g-3 needs-validation" novalidate>
                            @csrf
                            <div class="mb-3">
                                <label for="user-name" class="form-label fw-bold">الأسم</label>
                                <input id="user-name" type="text" name="name" value="{{ old('name', $user->name) }}"
                            ...
                            <div class="mb-3">
                                <label for="user-confirm-password" class="form-label fw-bold">تأكيد كلمة السر
                                    الجديدة</label>
                                <input id="user-confirm-password" type="password" name="password_confirmation"
