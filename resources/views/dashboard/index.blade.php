...
@section('content')
    <main id="main" class="main p-0 in-bg-srface">
        ...
        {{-- Add Board Modal --}}
        <div class="modal add-board-modal" id="add-board-modal" tabindex="-1" role="dialog"
                    ...
                    <div class="row m-0 p-0">
                        ...
                        <div class="col-6">
                            <div class="row m-0 p-0 cancel-add mb-3 p-3 justify-content-end">
                                <button id="close-add-board-modal-1" type="button" class="close injaaz-btn-close"
                                ...
                                <div class="row m-0 p-0 mt-4 board-info">
                                    <div class="board-name">
                                        <input id="board-name-input" type="text"
                                            class="form-control fw-bold board-name-input" name="boardName"
                                            placeholder="اسم اللوحة" aria-label="name" aria-describedby="basic-addon1">
                                    </div>
                                    <div class="mb-3 board-description">
                                        <textarea id="board-description-input" class="form-control fw-bold  " rows="5" name="boardDescription"
                                            placeholder="وصف اللوحة"></textarea>
                                    </div>
                                </div>
                                <div class="row m-0 p-0 py-3 mb-3 justify-content-center">
                                    <div class="col-10">
                                        <button id="btn-continue" type="submit"
                                            class="btn injaaz-btn w-100 fw-bold">متابعة</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="row m-0 p-0">
                        ...
                        <div class="col-6">
                            <div class="row m-0 p-0 cancel-add mb-3 p-3 justify-content-end gap-2">
                                ...
                                <button id="close-add-board-modal-2" type="button" class="close injaaz-btn-close"
                                    data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="row m-0 p-0 my-5 pt-4 invite-section">
                                <div id="board-add-dropdown" class="w-100 board-add-dropdown">
                                    <label class="form-label mb-4 fw-bold" for="invite-member">قم بدعوة أعضاء</label>
                                    {{-- onclick="boardToggleDropdown()" --}}
                                    <input type="text" id="invite-member-search" class="form-control board-name-input"
                                        oninput="CarateBoardFilterOptions()" placeholder="ابحث عن اعضاء">
                            ...
                            <div class="row m-0 p-0 py-3 my-3 justify-content-center">
                                <div class="col-10">
                                    <button id="btn-may-later" type="button"
                                        class="btn injaaz-btn-transperant fw-bold w-100" onclick="mayLater()">ربما
                                        لاحقا</button>
                                    <button id="btn-create-board" disabled type="button"
                                        class="btn injaaz-btn w-100 fw-bold my-2">انشاء اللوحة</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="p-5 pb-4 mt-5">
            ...
            <div class="col-2 mt-4">
                <button id="btn-add-board" class="btn injaaz-btn add-board-btn"
                    onclick="addBoardConfirm({{ Auth::user()->id }})">أضافة لوحة</button>
            </div>
        </div>
