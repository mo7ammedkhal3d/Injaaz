@extends('layouts.guest.guestsLayout')
@section('page_title', 'الرئيسية')
@include('layouts.guest.homehero')
@section('content')
    <!-- About Start -->
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4 text-end">
                        مرحبًا بك في مشروع إنجاز، حيث نسعى لجعل حياتك أكثر تنظيمًا وإدارة. إنجاز هو تطبيق ويب مبتكر يهدف إلى
                        تسهيل تنظيم المهام اليومية وتحقيق الأهداف بسهولة وفعالية
                        باستخدام واجهة مستخدم بسيطة وسهلة، يمكنك إدارة مهامك الشخصية أو مشاريع الفريق بكل يسر وسلاسة. يتيح
                        لك إنجاز تحديد الأولويات، ومتابعة تقدم المهام، وتعيين مسؤوليات الفريق بشكل فعّال.
                        نحن نقدم لك أدوات متقدمة تساعدك على فهم أداء المشروع بشكل أفضل، مما يمكنك من اتخاذ قرارات مستنيرة
                        وتحسين إنتاجيتك. انطلق الآن وابدأ رحلتك مع إنجاز لتجربة فريدة من نوعها في إدارة المهام وتحقيق
                        الإنجاز.
                    </p>
                    <div class="row g-3">
                        <div class="col-sm-6">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        ...
                        <a class="btn edit-text-primary btn-outline-primary btn-square ms-3" href=""><i
                                class="fab fa-facebook-f"></i></a>
                        <a class="btn edit-text-primary btn-outline-primary btn-square ms-3" href=""><i
                                class="fab fa-twitter"></i></a>
                        <a class="btn edit-text-primary btn-outline-primary btn-square ms-3" href=""><i
                                class="fab fa-instagram"></i></a>
                        <a class="btn edit-text-primary btn-outline-primary btn-square" href=""><i
        ...
        <div class="container px-lg-5">
            <div class="row align-items-center" style="height: 250px;">
                <div class="col-12 col-md-6">
                    ...
                    <small class="text-white">اشترك في نشرتنا الإخبارية لتكون أول من يعلم بآخر التحديثات والميزات الجديدة في
                        مشروع إنجاز</small>
                    <div class="position-relative w-100 mt-3">
                        <input class="form-control border-0 rounded-pill w-100 pe-4 ps-5" type="text"
                            placeholder="ادخل إيميلك" style="height: 48px;">
                        <button type="button" class="btn shadow-none position-absolute top-0 start-0 mt-1 me-2"><i
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <p>يقدم إنجاز تقارير دورية حول أداء المهام والمشروع بشكل عام لتمكينك من اتخاذ القرارات الاستراتيجية
                            بناءً على البيانات.</p>
                        <a class="btn px-3 mt-auto mx-auto" href="">اقرء المزيد</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <p>يمكن لفريق العمل تخصيص مهامه بشكل فعّال باستخدام أدوات التعيين والتحديد المتاحة في إنجاز لتحقيق
                            أقصى قدر من التنظيم.</p>
                        <a class="btn px-3 mt-auto mx-auto" href="">اقرء المزيد</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
    ...
    <div class="container-xxl edit-bg-primary testimonial py-5 my-5 wow fadeInUp" style="direction: ltr"
        data-wow-delay="0.1s">
        <div class="container py-5 px-lg-5">
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item bg-transparent border rounded text-white p-4">
                    <i class="fa fa-quote-left fa-2x mb-3"></i>
                    <p> أعجبتني خاصية تتبع الأداء، حيث يمكنني رؤية مدى تقدم المشروع بسهولة واتخاذ الإجراءات المناسبة تصميم
                        رائع ووظائف فعّالة، إنجاز أصبح لا غنى عنه في فريقنا. نجحنا في تحقيق تنظيم أفضل وزيادة في إنتاجيتنا
                    </p>
                ...
                <div class="testimonial-item bg-transparent border rounded text-white p-4">
                    <i class="fa fa-quote-left fa-2x mb-3"></i>
                    <p>إنجاز قلب مفاتيح إدارة المشاريع. بفضل واجهته البسيطة والأدوات المتقدمة، أصبح من السهل جدًا تنظيم
                        المهام ومتابعة التقدم بشكل دوري ساعدني إنجاز في إنجاز مشروعي الأخير في وقت أقل، وبنتائج تفوقت عن
                        توقعاتي</p>
                    <div class="d-flex align-items-center">
                        <img class="img-fluid flex-shrink-0 rounded-circle"
                ...
                <div class="testimonial-item bg-transparent border rounded text-white p-4">
                    <i class="fa fa-quote-left fa-2x mb-3"></i>
                    <p>إنجاز جعل تسويق عبر وسائل التواصل أمرًا سهلاً وممتعًا. يمكنني إدارة حملاتنا بفعالية وقياس أدائها بشكل
                        دقيق التعاون الفعّال مع فريقي أصبح أمرًا ضروريًا، وإنجاز يقدم لنا الأدوات اللازمة لتحقيق ذلك بنجاح
                    </p>
                    <div class="d-flex align-items-center">
                        <img class="img-fluid flex-shrink-0 rounded-circle"
                ...
                <div class="testimonial-item bg-transparent border rounded text-white p-4">
                    <i class="fa fa-quote-left fa-2x mb-3"></i>
                    <p>تجربتي مع إنجاز كانت استثنائية. سهولة الاستخدام والأداء المتميز جعلت من تنظيم مشروعي أمرًا ممتعًا
                        استفدت كثيرًا من دعم العملاء الرائع، حيث تمكنوا من حل أي استفسار بفعالية وسرعة</p>
                    <div class="d-flex align-items-center">
                        <img class="img-fluid flex-shrink-0 rounded-circle"
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="d-flex">
                            ...
                            <img class="img-fluid rounded w-100" src="{{ asset('assets/img/team-1.png') }}"
                                alt="">
                        </div>
                        <div class="px-4 py-3">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="d-flex">
                            ...
                            <img class="img-fluid rounded w-100" src="{{ asset('assets/img/team-2.png') }}"
                                alt="">
                        </div>
                        <div class="px-4 py-3">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="d-flex">
                            ...
                            <img class="img-fluid rounded w-100" src="{{ asset('assets/img/team-3.png') }}"
                                alt="">
                        </div>
                        <div class="px-4 py-3">
